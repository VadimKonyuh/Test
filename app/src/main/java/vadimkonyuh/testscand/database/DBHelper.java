package vadimkonyuh.testscand.database;
...
import vadimkonyuh.testscand.Model.Order;
import vadimkonyuh.testscand.Model.Product;
import vadimkonyuh.testscand.Model.User;

public class DBHelper extends OrmLiteSqliteOpenHelper {

    // Fields

    public static final String DB_NAME = "product_manager.db";
